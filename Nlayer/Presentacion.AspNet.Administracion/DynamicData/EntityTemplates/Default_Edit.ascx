<%@ Control Language="C#" CodeBehind="Default_Edit.ascx.cs" Inherits="Sci.Nlayer.Presentacion.AspNet.Administracion.DynamicData.EntityTemplates.Default_EditEntityTemplate" %>
