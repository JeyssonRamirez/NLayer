<%@ Control Language="C#" CodeBehind="ForeignKey_Edit.ascx.cs" Inherits="Sci.Nlayer.Presentacion.AspNet.Administracion.DynamicData.FieldTemplates.ForeignKey_EditField" %>
