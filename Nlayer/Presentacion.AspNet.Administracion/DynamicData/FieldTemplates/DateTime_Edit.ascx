<%@ Control Language="C#" CodeBehind="DateTime_Edit.ascx.cs" Inherits="Sci.Nlayer.Presentacion.AspNet.Administracion.DynamicData.FieldTemplates.DateTime_EditField" %>
